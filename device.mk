...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/audio_policy_configuration_a2dp_offload_disabled.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_lahaina_qssi/audio_policy_configuration.xml 
...
PRODUCT_PACKAGES += \
    OplusDoze
#Dolby
$(call inherit-product, $(LOCAL_PATH)/dolby/dolby.mk)
...
# Overlays
$(call inherit-product, $(LOCAL_PATH)/overlay/qssi/qssi.mk)
